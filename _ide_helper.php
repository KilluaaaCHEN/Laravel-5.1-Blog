 ...
 * Generated for Laravel 5.1.19 (LTS) on 2015-10-29.
 *
...
namespace {
    ...
    class Entrust extends \Parsidev\Entrust\EntrustFacade{
        
        /**
         * Checks if the current user has a roles by its name
         *
        ...
        public static function hasRole($role, $requireAll = false){
            return \Parsidev\Entrust\Entrust::hasRole($role, $requireAll);
        }
        ...
        public static function can($permission, $requireAll = false){
            return \Parsidev\Entrust\Entrust::can($permission, $requireAll);
        }
        
        /**
         * Get the currently authenticated user or null.
         *
         * @return \Parsidev\Entrust\Illuminate\Auth\UserInterface|null 
         * @static 
         */
        public static function user(){
            return \Parsidev\Entrust\Entrust::user();
        }
        
        /**
         * Filters a route for a roles or set of roles.
         * 
         * If the third parameter is null then abort with status code 403.
         * Otherwise the $result is returned.
         *
         * @param string $route Route pattern. i.e: "admin/*"
         * @param array|string $roles The roles(s) needed
        ...
        public static function routeNeedsRole($route, $roles, $result = null, $requireAll = true){
            return \Parsidev\Entrust\Entrust::routeNeedsRole($route, $roles, $result, $requireAll);
        }
        ...
        public static function routeNeedsPermission($route, $permissions, $result = null, $requireAll = true){
            return \Parsidev\Entrust\Entrust::routeNeedsPermission($route, $permissions, $result, $requireAll);
        }
        
        /**
         * Filters a route for roles(s) and/or permission(s).
         * 
         * If the third parameter is null then abort with status code 403.
         * Otherwise the $result is returned.
         *
        ...
        public static function routeNeedsRoleOrPermission($route, $roles, $permissions, $result = null, $requireAll = false){
            \Parsidev\Entrust\Entrust::routeNeedsRoleOrPermission($route, $roles, $permissions, $result, $requireAll);
        }
